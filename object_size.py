...
for c in cnts:
    ...
    # save the output image with measurements
    output_path = f"output_contour_{count + 1}.png"
    cv2.imwrite(output_path, orig)

    # print the measurements to the terminal
    print(f"Contour {count + 1}: Width = {dimB:.1f} in, Height = {dimA:.1f} in, Area = {area:.2f}")
